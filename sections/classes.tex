...
\begin{frame}{Classes}{Access specifiers}
	...
	\begin{itemize}
		\item \textbg{data members} are almost always \texttt{private};
...
\begin{frame}{Classes}{Separating declaration from definition}
	...
	\begin{itemize}
		...
		\item \textbg{inline function definitions} (small, frequently called functions).
	\end{itemize}
	\bigskip
	...
	\begin{block}{Why split?}
		...
		Keeping implementation in \texttt{.cpp} files reduces \textbf{compile-time dependencies} and hides internals.
	\end{block}
\end{frame}
