...
\begin{frame}{The C-to-C++ transition}{What changes}
	...
	\end{itemize}
	\bigskip
	\textbg{Compilation} uses a C++-aware compiler and specifying the \textbf{language standard} is relevant:
	\begin{itemize}
...
\begin{frame}{The C-to-C++ transition}
  \begin{block}{}
    ...
    Code examples are available \href{https://github.com/IntelligentSystemsLabUTV/ros2-examples/tree/jazzy/tools/cpp-examples}{\color{blue}\underline{in this subfolder}} of the materials.
  \end{block}
\end{frame}
